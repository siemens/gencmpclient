...
# define OPENSSL_4_0_FEATURES (OPENSSL_VERSION_NUMBER >= 0x40000000L)
# define OPENSSL_4_1_FEATURES (OPENSSL_VERSION_NUMBER >= 0x40100000L)
# define OPENSSL_4_2_FEATURES (OPENSSL_VERSION_NUMBER >= 0x40200000L)
