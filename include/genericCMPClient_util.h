...
# define CERT_check_all(uri, certs, type_CA, vpm) \
    ossl_X509_check_all(NULL, uri, certs, type_CA, vpm)
...
# endif
bool STORE_set1_host_ip(X509_STORE *truststore, const char *name,
                        const char *ip);
